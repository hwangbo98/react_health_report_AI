...
#         with connection.cursor(pymysql.cursors.DictCursor) as cursor:
#             # 사용자 정보 가져오기
#             sql_user = "SELECT user_name, job FROM users WHERE user_id = %s"
#             cursor.execute(sql_user, (user_id,))
#             user_info = cursor.fetchone()

#             # 건강 데이터 가져오기
#             sql_health = "SELECT * FROM health_data WHERE user_id = %s"
#             cursor.execute(sql_health, (user_id,))
#             health_data = cursor.fetchone()

#             if user_info and health_data:
#                 return {**user_info, **health_data}
#             else:
#                 return None
#     finally:
#         connection.close()
...
#         total_body_water = user_data['total_body_water']
#         protein = user_data['protein']
#         minerals = user_data['minerals']
#         body_fat_mass = user_data['body_fat_mass']
#         skeletal_muscle_mass = user_data['skeletal_muscle_mass']
#         date = user_data['date']
